...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(translate, group, element, data) {
  ...
  // Table
  if (!(0,bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_2__.is)(element, 'bpmn:Collaboration')) {
    group.entries.push(bpmn_js_properties_panel_lib_factory_EntryFactory__WEBPACK_IMPORTED_MODULE_0___default().table(translate, {
        id: 'data',
        labels: ['Name', 'Value'],
...
/* harmony import */ var _propertiesProvider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./propertiesProvider */ "./client/propertiesProvider/index.js");
...
const TokenSimulationPluginModule = {
  __depends__: [
    _propertiesProvider__WEBPACK_IMPORTED_MODULE_3__.default
  ],
